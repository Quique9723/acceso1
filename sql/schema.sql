...
create table product (discount DECIMAL(5,2) default 0 CHECK(discount >=0 and discount <=100), price double default 0.0, stock integer default 25, valuation integer default 1 CHECK(valuation >=1 and valuation <=5), family_product_id bigint, id bigint generated by default as identity, name varchar(225) default 'TBD' not null, picture_url varchar(255), primary key (id));
